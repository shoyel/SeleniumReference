 ...
 */
public class SpreeDriverEx2 extends SpreeScriptBaseTestNg {

    @Test(dataProvider = "scriptNames")
    public void driverScript(String scriptFile, String scriptName, String runScript){
        Object[][] data = null;
    ...
    public static Object[][] scriptNames(){
        Object[][] data = {
                           ...
                           {"/src/test/resources/KW-Scripts/KWScript3.xlsx","Login01","Y"},
                           {"/src/test/resources/KW-Scripts/KWScript3.xlsx","Login02","Y"},
                           {"/src/test/resources/KW-Scripts/KWScript3.xlsx","Login03","Y"},
                           {"/src/test/resources/KW-Scripts/KWScript3.xlsx","Login04","Y"}
                          };
        return data;
    }
}
